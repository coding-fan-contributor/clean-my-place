...
<body>
    <div class="welcome1">
        <div class="mail-body">
            Hello {{$name}},<br/><br/>
            Please use the below code in order to reset your password:<br/><br/>
            <strong>{{$code}}</strong><br/><br/>
            If you didn't request to change your password, please get in touch with us immediately using support@cleanmyplace.com.<br/><br/>

            Regards,<br/><br/>
            {{env('APP_NAME')}} Team
        </div>
        <div class="footer">
            <p>&copy; 2019 {{env('APP_NAME')}} All Right Reserved</p>
        </div>
    </div>
</body>
</html>
